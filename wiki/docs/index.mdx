...
- **[Configuration](./user-guide/configuration.mdx):** Learn how to configure MyDE to your needs.
- **[Applications](./user-guide/applications.mdx):** Discover the applications included in MyDE.
...
- **[MyCTL Modules](./dev-guide/myctl-modules.mdx)**: Learn how to create MyCTL modules.
